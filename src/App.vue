<template>
	...
	<blush-badge
		...
		variant="neutral-outline"
		show-dismiss
		@on-dismiss="dismissBadgeHandler"
	/>
	<hr>
	...
	<blush-card
		...
		variant="neutral-outline"
		image-src="https://picsum.photos/600/300/?image=25"
		image-alt="Alt image card"
		image-placement="top"
	...
	<blush-checkbox
		...
		state="invalid"
		@on-change="changeCheckboxHandler"
		@on-input="inputCheckboxHandler"
	/>
	<br>
	...
	<blush-radio
		...
		error-text="Erro genérico"
		state="normal"
		@on-change="changeRadioHandler"
		@on-input="inputRadioHandler"
	/>
	<br>
	<blush-radio
		v-model="radioVModel"
	...
	<div style="max-width: 300px;">
		<blush-input-text
			...
			@on-change="changeInputTextHandler"
			@on-input="inputInputTextHandler"
			@on-focus="focusInputTextHandler"
			@on-blur="blurInputTextHandler"
		/>
		<br>
	...
	<blush-modal
		...
		@on-open="console.log('modal open')"
	>
		<template #header>
			Header
		</template>
	...
	<blush-collapse
		...
		variant="neutral-outline"
		@on-change-collapse-visibility="onChangeCollapseVisibility"
	>
		conteudo collapse
	</blush-collapse>
	<blush-collapse
	...
	<blush-button
		...
		variant="primary"
		size="large"
		@on-click="$toasts.add({ title: 'Toast disparado', text: 'Conteúdo', type: 'informative', showDismiss: true})"
	/>
	<div
